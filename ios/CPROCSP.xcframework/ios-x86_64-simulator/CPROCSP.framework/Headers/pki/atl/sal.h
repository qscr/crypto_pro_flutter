...
/* 
 ...
 LWSTDAPI_(CSP_BOOL) StrToIntExA(
 ...
 LWSTDAPI_(CSP_BOOL) PathCompactPathExA(
 ...
 __success(return == TRUE) LWSTDAPI_(CSP_BOOL) 
...
// __null был переименован в __null1 из-за конфликта с определением __null в gcc
...
*/
    ...
    */
    ...
    #define __null1                  __declspec("SAL_null")
...
#define __reserved                          __pre __null1
