...
//  акие-то махинации дл€ .NET, в портируемых исходниках ATL это символа не встречаетс€
// ORIG: #if !defined(_ATL_MIXED)
// ORIG: namespace Inconsistent_definition_of_symbol__ATL_MIXED
// ORIG: {
// ORIG: 	struct _Please_define_it_the_same_throughout_your_project { };
// ORIG: }
// ORIG: #else
// ORIG: namespace Inconsistent_definition_of_symbol__ATL_MIXED
// ORIG: {
// ORIG: #ifdef _M_IX86
// ORIG: #pragma comment(linker, "/include:??3@YAXPAX@Z")
// ORIG: #else
// ORIG: #pragma comment(linker, "/include:??3@YAXPEAX@Z")
// ORIG: #endif
// ORIG: 	struct _Please_define_it_the_same_throughout_your_project { virtual void one(){} };
// ORIG: }
// ORIG: #endif
// ORIG: namespace Inconsistent_definition_of_symbol__ATL_MIXED
// ORIG: {
// ORIG: 	__declspec(selectany) _Please_define_it_the_same_throughout_your_project clash = _Please_define_it_the_same_throughout_your_project ();
// ORIG: }
// ORIG: 
// ORIG: #if !defined(_ATL_MIXED)
// ORIG: namespace Define_the_symbol__ATL_MIXED
// ORIG: {
// ORIG: #if defined(_M_CEE)
// ORIG: 	struct Thank_you { };
// ORIG: #else
// ORIG: #ifdef _M_IX86
// ORIG: #pragma comment(linker, "/include:??3@YAXPAX@Z")
// ORIG: #else
// ORIG: #pragma comment(linker, "/include:??3@YAXPEAX@Z")
// ORIG: #endif
// ORIG: 	struct Thank_you { virtual void one(){} };
// ORIG: #endif
// ORIG: 	__declspec(selectany) Thank_you clash = Thank_you();
// ORIG: }
// ORIG: #endif
...
#else
	#ifndef _CPPUNWIND
// ORIG:	#define _ATL_NO_EXCEPTIONS
	#endif
#endif
...
#define offsetofclass(base, derived) ((DWORD_PTR)(static_cast<base*>((derived*) 8 /* _ATL_PACKING */))- 8 /* _ATL_PACKING */)
...
#if !defined(FREEBSD) && !defined(DARWIN) && !defined(IOS)
    #include <malloc.h>
#else
    #include <stdlib.h>
#endif /* FREEBSD */
