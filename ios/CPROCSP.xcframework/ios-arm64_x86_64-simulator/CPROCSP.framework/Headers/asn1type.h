...
typedef struct ASN1MemBuf {
   ...
   ASN1BOOL     isDynamic;      /* is buffer allocated dynamically? */
} ASN1MemBuf;
...
typedef struct _OSDATETIME {
   ...
   ASN1BOOL mUtcFlag;  /* is Z flag present or not */
} OSDATETIME;
...
EXTERNRT ASN1BOOL rtIsMinusInfinity (ASN1REAL value);
EXTERNRT ASN1BOOL rtIsMinusZero (ASN1REAL value);
EXTERNRT ASN1BOOL rtIsNaN (ASN1REAL value);
EXTERNRT ASN1BOOL rtIsPlusInfinity (ASN1REAL value);
...
EXTERNRT ASN1BOOL rtIsIn16BitCharSet (ASN116BITCHAR ch, 
                                      Asn116BitCharSet* pCharSet);
...
#if !defined NO_ASN1_RT_REDUNDANT
EXTERNRT ASN1BOOL rtIsIn32BitCharSet (ASN132BITCHAR ch, 
                                      Asn132BitCharSet* pCharSet);
#endif	/* !NO_ASN1_RT_REDUNDANT */
