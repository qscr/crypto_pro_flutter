...
inline DWORD_PTR __stdcall AtlTraceRegister(HINSTANCE /*hInst*/,
	int (__cdecl *fnCrtDbgReport)(int,const char *,int,const char *,const char *,...))
{
	((void)fnCrtDbgReport);
	return 0;
...
CSP_BOOL __stdcall AtlTraceUnregister(DWORD_PTR dwModule);

inline CSP_BOOL __stdcall AtlTraceUnregister(DWORD_PTR /*dwModule*/)
{
	return TRUE;
}

DWORD_PTR __stdcall AtlTraceRegisterCategoryA(DWORD_PTR dwModule, const CHAR szCategoryName[ATL_TRACE_MAX_NAME_SIZE]);
inline DWORD_PTR __stdcall AtlTraceRegisterCategoryA(DWORD_PTR /*dwModule*/, const CHAR szCategoryName[ATL_TRACE_MAX_NAME_SIZE])
{
	((void)szCategoryName);
	return 0;
}
DWORD_PTR __stdcall AtlTraceRegisterCategoryU(DWORD_PTR dwModule, const WCHAR szCategoryName[ATL_TRACE_MAX_NAME_SIZE]);
inline DWORD_PTR __stdcall AtlTraceRegisterCategoryU(DWORD_PTR /*dwModule*/, const WCHAR szCategoryName[ATL_TRACE_MAX_NAME_SIZE])
{
	((void)szCategoryName);
	return 0;
}

CSP_BOOL __stdcall AtlTraceModifyProcess(DWORD_PTR dwProcess, UINT nLevel, CSP_BOOL bEnabled, CSP_BOOL bFuncAndCategoryNames, CSP_BOOL bFileNameAndLineNo);
CSP_BOOL __stdcall AtlTraceModifyModule(DWORD_PTR dwProcess, DWORD_PTR dwModule, UINT nLevel, ATLTRACESTATUS eStatus);
CSP_BOOL __stdcall AtlTraceModifyCategory(DWORD_PTR dwProcess, DWORD_PTR dwCategory, UINT nLevel, ATLTRACESTATUS eStatus);
inline CSP_BOOL __stdcall AtlTraceModifyCategory(DWORD_PTR /*dwProcess*/, DWORD_PTR /*dwCategory*/, UINT /*nLevel*/, ATLTRACESTATUS /*eStatus*/)
{
	return TRUE;
}
CSP_BOOL __stdcall AtlTraceGetProcess(DWORD_PTR dwProcess, UINT *pnLevel, CSP_BOOL *pbEnabled, CSP_BOOL *pbFuncAndCategoryNames, CSP_BOOL *pbFileNameAndLineNo);
CSP_BOOL __stdcall AtlTraceGetModule(DWORD_PTR dwProcess, DWORD_PTR dwModule, UINT *pnLevel, ATLTRACESTATUS *pStatus);
CSP_BOOL __stdcall AtlTraceGetCategory(DWORD_PTR dwProcess, DWORD_PTR dwCategory, UINT *pnLevel, ATLTRACESTATUS *pStatus);
...
inline void __cdecl AtlTraceVA(DWORD_PTR /*dwModule*/, const char * /*pszFileName*/, int /*nLineNo*/,
						DWORD_PTR /*dwCategory*/, UINT /*nLevel*/, const CHAR * /*pszFormat*/, va_list /*ptr*/)
{
}
...
CSP_BOOL __stdcall AtlTraceLoadSettingsA(const CHAR *pszFileName, DWORD_PTR dwProcess = 0);
CSP_BOOL __stdcall AtlTraceLoadSettingsU(const WCHAR *pszFileName, DWORD_PTR dwProcess = 0);
CSP_BOOL __stdcall AtlTraceSaveSettingsA(const CHAR *pszFileName, DWORD_PTR dwProcess = 0);
CSP_BOOL __stdcall AtlTraceSaveSettingsU(const WCHAR *pszFileName, DWORD_PTR dwProcess = 0);
...
{
	UINT nLevel;
	CSP_BOOL bEnabled, bFuncAndCategoryNames, bFileNameAndLineNo;
...
CSP_BOOL __stdcall AtlTraceGetProcessInfo(DWORD_PTR dwProcess, ATLTRACEPROCESSINFO* pProcessInfo);
