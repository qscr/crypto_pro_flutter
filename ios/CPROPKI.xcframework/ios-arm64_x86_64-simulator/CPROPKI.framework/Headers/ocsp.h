...
/*!
 * \file $RCSfile$
 * \version $Revision: 262543 $
 * \date $Date:: 2023-10-09 04:04:48 -0700#$
 * \author $Author: anna $
 *
...
#           include <CPROPKI/pki_ocsp_assembly.h>
#           ifdef _WIN64
 ...
 * 
 * OCSP ответ типа szOID_PKIX_OCSP_BASIC_SIGNED_RESPONSE. Содержит список ответов на запросы
