...
#define XADES_ACCEPT_ANY_ID_ATTR_NAMESPACE              0x00000010
...
XADES_API CSP_BOOL WINAPI CryptEncryptXml(
    ...
    __out PCRYPT_DATA_BLOB *ppEncryptedBlob);

XADES_API CSP_BOOL WINAPI CryptDecryptXml(
    __in PCRYPT_DECRYPT_MESSAGE_PARA pDecryptPara,
    __in const BYTE *pbEncryptedBlob,
    __in DWORD cbEncryptedBlob,
    __out PCRYPT_DATA_BLOB *ppDecryptedBlob);
